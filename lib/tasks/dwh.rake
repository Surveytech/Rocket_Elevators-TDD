...
namespace :dbr do
  ...
  task runall: :environment do
    ...
    dwh = PG::Connection.new(host: 'localhost', port: 5432, dbname: "csl", user: "surveytech", password: "2304godZ")
  ...
  #   # dwh = PG::Connection.new(host: 'codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com', port: 5432, dbname: "csl", user: "codeboxx", password: "Codeboxx1!")
  #   dwh = PG::Connection.new(host: 'localhost', port: 5432, dbname: "CSL_psql", user: "surveytech", password: "2304godZ")
